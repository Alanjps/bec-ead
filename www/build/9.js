...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__file_modal__ = __webpack_require__(885);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__photo__ = __webpack_require__(905);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_menu_sup_menu_sup_module__ = __webpack_require__(876);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_file_modal_file_modal_module__ = __webpack_require__(854);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var FileModalComponent = /** @class */ (function () {
    ...
    FileModalComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["Component"])({
            selector: 'file-modal',template:/*ion-inline-start:"C:\Users\Alan\Desktop\ALAN\TRABALHO\VISION\PROJETOS\BEC\EAD\IONIC\PROJETO\EAD\src\components\file-modal\file-modal.html"*/'<ion-content padding class="background">\n\n  <div>\n\n    <img src={{file}}>\n\n  </div>\n\n  <div>\n\n    <button class="button-style button-style-{{ENV.PROJECT}}" ion-button (click)="confirm()">Confirmar</button>\n\n    <button class="button-style button-style-{{ENV.PROJECT}}" ion-button (click)="cancel()">Cancelar</button>\n\n  </div>\n\n</ion-content>\n\n'/*ion-inline-end:"C:\Users\Alan\Desktop\ALAN\TRABALHO\VISION\PROJETOS\BEC\EAD\IONIC\PROJETO\EAD\src\components\file-modal\file-modal.html"*/
        }),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(68);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__ionic_storage__ = __webpack_require__(49);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_http_service_http_service__ = __webpack_require__(161);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__angular_animations__ = __webpack_require__(162);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__environments_environment__ = __webpack_require__(160);
...
var PhotoPage = /** @class */ (function () {
    function PhotoPage(storage, camera, modalCtrl, actionSheetCtrl, http, loadingCtrl, alertCtrl, toastCtrl, menu, DomSanitizer) {
        ...
        this.ENV = __WEBPACK_IMPORTED_MODULE_7__environments_environment__["a" /* environment */];
            ...
            _this.storage.get('clienteId').then(function (clienteId) {
                _this.http.getAll('/api/conteudos', { company_id: companyId, user_id: clienteId, type: "ICON4" })
                    ...
                    if (data.length > 0) {
                        ...
                        _this.subcategories = data[0].subcategories;
                        _this.observation = data[0].observation;
    ...
    PhotoPage.prototype.getPics = function () {
        ...
        this.storage.get('clienteCompanyId').then(function (companyId) {
            _this.storage.get('clienteId').then(function (clienteId) {
                _this.http.getAll('/api/projeto/images', { project_id: _this.imageProject.id }).subscribe(function (data) {
                    _this.pics = data.length ? data.map(function (p) {
                        var subcategoriesArray = [];
                        if (p.image_subcategory_id && _this.subcategories && _this.subcategories.length > 0 && p.image_subcategory_id.trim() != '[]') {
                            JSON.parse(p.image_subcategory_id).map(function (id) {
                                subcategoriesArray.push(_this.subcategories.filter(function (s) { return s.id == id; })[0]);
                            });
                        }
                        return __assign({}, p, { created_at: _this.idiom == '02' ? __WEBPACK_IMPORTED_MODULE_8_moment___default()(p.created_at).locale('es').format('lll') : __WEBPACK_IMPORTED_MODULE_8_moment___default()(p.created_at).locale('pt-br').format('lll'), user: __assign({}, p.user, { thumb: p.user && p.user.thumb != null ? p.user.thumb : _this.iconUserProfile }), category: _this.categories ?
                                _this.categories.filter(function (c) { return c.id == p.image_category_id; })[0]
                                : null, subcategories: subcategoriesArray.length > 0 ? subcategoriesArray : null, uploaded_time: _this.idiom == '02' ? p.uploaded_time.replace('há', 'hace') : p.uploaded_time, liked: p.likes.length > 0 ?
    ...
    PhotoPage.prototype.getPic = function (gallery, camera) {
        ...
        this.camera.getPicture(options).then(function (imageData) {
            ...
            var photoModal = _this.modalCtrl.create('photo-modal', { photo: _this.fileUpload, categories: _this.categories, subcategories: _this.subcategories, observation: _this.observation, contestEnabled: _this.contestEnabled, userCategoriesInContest: _this.userCategoriesInContest });
