...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__list_videos_v02__ = __webpack_require__(902);
...
var ListVideosV02Page = /** @class */ (function () {
    ...
    ListVideosV02Page.prototype.checaResultado = function (lesson, showAlert) {
        var _this = this;
        var lesson_id = lesson.id;
        var user_id = 0;
        this.storage.get('clienteId').then(function (valor) {
